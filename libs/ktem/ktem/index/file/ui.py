...
from ktem.connectors.google_drive.sync_state import GoogleDriveStateStore
from ktem.connectors.google_drive.ui_drive_tab import GoogleDriveTab
...
class FileIndexPage(BasePage):
            ...
            with gr.Column(scale=1):
                with gr.Column() as self.upload:
                    ...
                    with gr.Tab("Google Drive"):
                        self.google_drive_tab = GoogleDriveTab(
                            self._app,
                            self._index,
                            self,
                        )
    ...
    def delete_event(self, file_id):
        ...
        self._index.delete_source(file_id)
        GoogleDriveStateStore().delete_mappings_by_source_id(file_id)
