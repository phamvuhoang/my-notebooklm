...
KH_GOOGLE_DRIVE_ENABLED = config("KH_GOOGLE_DRIVE_ENABLED", default=True, cast=bool)
KH_GOOGLE_DRIVE_OAUTH_CLIENT_ID = config(
    "KH_GOOGLE_DRIVE_OAUTH_CLIENT_ID",
    default="",
)
KH_GOOGLE_DRIVE_OAUTH_CLIENT_SECRET = config(
    "KH_GOOGLE_DRIVE_OAUTH_CLIENT_SECRET",
    default="",
)
KH_GOOGLE_DRIVE_OAUTH_REDIRECT_URI = config(
    "KH_GOOGLE_DRIVE_OAUTH_REDIRECT_URI",
    default="http://127.0.0.1:8765/google-drive/callback",
)
KH_GOOGLE_DRIVE_SERVICE_ACCOUNT_FILE = config(
    "KH_GOOGLE_DRIVE_SERVICE_ACCOUNT_FILE",
    default="",
)
KH_GOOGLE_DRIVE_SERVICE_ACCOUNT_JSON = config(
    "KH_GOOGLE_DRIVE_SERVICE_ACCOUNT_JSON",
    default="",
)
KH_GOOGLE_DRIVE_SERVICE_ACCOUNT_SUBJECT = config(
    "KH_GOOGLE_DRIVE_SERVICE_ACCOUNT_SUBJECT",
    default="",
)
KH_GOOGLE_DRIVE_MASTER_KEY_PATH = str(
    Path(
        config(
            "KH_GOOGLE_DRIVE_MASTER_KEY_PATH",
            default=str(KH_USER_DATA_DIR / "google_drive.key"),
        )
    )
)
KH_GOOGLE_DRIVE_SCOPES = [
    "https://www.googleapis.com/auth/drive.readonly",
    "https://www.googleapis.com/auth/documents.readonly",
    "https://www.googleapis.com/auth/spreadsheets.readonly",
    "https://www.googleapis.com/auth/presentations.readonly",
]
KH_GOOGLE_DRIVE_FOLDER_PAGE_SIZE = config(
    "KH_GOOGLE_DRIVE_FOLDER_PAGE_SIZE",
    default=1000,
    cast=int,
)
